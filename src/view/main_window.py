...
"color: rgb(255, 255, 255);")
        ...
        self.new_acc_btn = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Roboto Condensed")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.new_acc_btn.setFont(font)
        self.new_acc_btn.setContextMenuPolicy(QtCore.Qt.DefaultContextMenu)
        self.new_acc_btn.setToolTip("")
        self.new_acc_btn.setStatusTip("")
        self.new_acc_btn.setWhatsThis("")
        self.new_acc_btn.setAccessibleName("")
        self.new_acc_btn.setAccessibleDescription("")
        self.new_acc_btn.setStyleSheet("background-color: rgb(66, 66, 66);\n"
"color: rgb(255, 255, 255);")
        self.new_acc_btn.setObjectName("new_acc_btn")
        self.verticalLayout.addWidget(self.new_acc_btn)
...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.new_acc_btn.setText(_translate("MainWindow", "Добавить новый аккаунт"))
